gulp docker:stop --host 172.24.40.25 --username root --password tHYGN27A9cQM --service redis-manager-ui
...
gulp docker:start --host 172.24.40.25 --username root --password tHYGN27A9cQM --service redis-manager-ui
